    ...
    execute: function () {
      ...
      _export("Car", Car = (_dec = ccclass('Car'), _dec(_class = (_class2 = (_temp = class Car extends Component {
        constructor(...args) {
          ...
          _defineProperty(this, "_tootingCoolTime", 0);

          _defineProperty(this, "_minSpeed", 0);

          _defineProperty(this, "_maxSpeed", 0);

          _defineProperty(this, "_runState", RunState.NORMAL);
        }
        ...
        tooting() {
          ...
          const audioSource = Math.floor(Math.random() * 2) < 1 ? (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
