    ...
    execute: function () {
      ...
      _export("RoadPoint", RoadPoint = (_dec = ccclass('RoadPoint'), _dec2 = property({
        ...
        function RoadPoint() {
          ...
          _defineProperty(_assertThisInitialized(_this), "_arrCars", []);

          _defineProperty(_assertThisInitialized(_this), "_cd", null);
        ...
        _proto.startSchedule = function startSchedule(cd) {
