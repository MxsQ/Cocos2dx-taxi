System.register(["cce:/internal/code-quality/cr.mjs", "cc", "../game/AudioManager"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BtnAdapter", BtnAdapter = (_dec = ccclass('BtnAdapter'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function BtnAdapter() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "soundName", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "delayTime", _descriptor2, _assertThisInitialized(_this));
        ...
        return BtnAdapter;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "soundName", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
